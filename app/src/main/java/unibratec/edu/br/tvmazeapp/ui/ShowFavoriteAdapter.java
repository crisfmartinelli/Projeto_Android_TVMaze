...
public class ShowFavoriteAdapter extends ArrayAdapter{
    public ShowFavoriteAdapter(Context context, List<Show> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.textViewName.setText(show.name);
        vh.textViewLanguage.setText(show.language);
        vh.textViewStatus.setText(show.status);

        if (show.images != null && show.images.medium != null) {
            Glide
                    .with(getContext())
                    .load(show.images.medium)
                    .into(vh.imageView);
        }else {
